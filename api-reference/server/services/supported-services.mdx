...
description: "The full catalog of AI services integrated with Pipecat: STT, TTS, LLM, transports, and more, with setup requirements."
---
...
| [floe-guard](/api-reference/server/services/analytics/floe)             | `uv add "floe-guard[pipecat]"`                 | Community  |
| [Future AGI](/api-reference/server/services/analytics/future-agi)       | `uv add traceAI-pipecat`                       | Community  |
| [MLflow](/api-reference/server/services/analytics/mlflow)               | `uv add "pipecat-ai[tracing]" mlflow`          | Community  |
...
| [pipecat-effects](/api-reference/server/services/audio-filters/pipecat-effects) | `uv add pipecat-effects`       | Community  |
| [RNNoise](/api-reference/server/services/audio-filters/rnnoise-filter)          | `uv add "pipecat-ai[rnnoise]"` | Pipecat    |

## Extensions

Extensions add conversational behavior to a pipeline. They are built from frame processors rather than wrapping a third-party API.

| Extension                                                                   | Setup                        | Maintainer |
| --------------------------------------------------------------------------- | ---------------------------- | ---------- |
| [IVRNavigator](/api-reference/server/extensions/ivr)                        | Built in                     | Pipecat    |
| [Pipecat Backchannel](/api-reference/server/extensions/pipecat-backchannel) | `uv add pipecat-backchannel` | Community  |
| [VoicemailDetector](/api-reference/server/extensions/voicemail)             | Built in                     | Pipecat    |
...
| Service                                                                 | Setup                           | Maintainer |
| ----------------------------------------------------------------------- | ------------------------------- | ---------- |
| [Keenable](/api-reference/server/services/knowledge-retrieval/keenable) | `uv add "pipecat-ai[keenable]"` | Pipecat    |
...
| [Baseten](/api-reference/server/services/llm/baseten)                   | `uv add "pipecat-ai[baseten]"`    | Pipecat    |
...
| [Floe](/api-reference/server/services/llm/floe)                         | `uv add pipecat-floe`             | Community  |
...
| [Simplismart](/api-reference/server/services/llm/simplismart)           | `uv add pipecat-simplismart`      | Community  |
...
| [OpenAI GPT-Live](/api-reference/server/services/s2s/openai-live)              | `uv add "pipecat-ai[openai]"`         | Pipecat    |
| [OpenAI Realtime](/api-reference/server/services/s2s/openai)                   | `uv add "pipecat-ai[openai]"`         | Pipecat    |
| [ThunderPhone](/api-reference/server/services/s2s/thunderphone)                | `uv add pipecat-thunderphone`         | Community  |
...
| Service                                                           | Setup                      | Maintainer |
| ----------------------------------------------------------------- | -------------------------- | ---------- |
| [Acefone](/api-reference/server/services/serializers/acefone)     | `uv add pipecat-acefone`   | Community  |
...
| [Floe](/api-reference/server/services/stt/floe)                 | `uv add pipecat-floe`                                                         | Community  |
| [FunASR](/api-reference/server/services/stt/funasr)             | `uv add "pipecat-ai[funasr]"`                                                 | Pipecat    |
...
| [Meta](/api-reference/server/services/stt/meta)                 | `uv add "pipecat-ai[meta]"`                                                   | Pipecat    |
...
| [Oruk](/api-reference/server/services/stt/oruk)                 | `uv add "pipecat-oruk==0.1.0rc1"`                                             | Community  |
| [Quickdial](/api-reference/server/services/stt/quickdial)       | `uv add pipecat-quickdial`                                                    | Community  |
...
| [Simplismart](/api-reference/server/services/stt/simplismart)   | `uv add pipecat-simplismart`                                                  | Community  |
...
| [Chariot](/api-reference/server/services/tts/chariot)             | `uv add pipecat-chariot`                                                              | Community  |
...
| [SILMA AI](/api-reference/server/services/tts/silma)              | `uv add pipecat-silma`                                                                | Community  |
...
| Service                                                                        | Setup                        | Maintainer |
| ------------------------------------------------------------------------------ | ---------------------------- | ---------- |
| [ai-coustics Quail](/api-reference/server/services/vad/aic-quail-vad-analyzer) | `uv add "pipecat-ai[aic]"`   | Pipecat    |
| [FIRE RED VAD](/api-reference/server/services/vad/fire-vad)                    | `uv add pipecat-firered-vad` | Community  |
| [Krisp VIVA](/api-reference/server/services/vad/krisp-viva-vad-analyzer)       | `uv add "pipecat-ai[krisp]"` | Pipecat    |
| [Silero](/api-reference/server/services/vad/silero-vad-analyzer)               | Built in                     | Pipecat    |
| [TEN VAD](/api-reference/server/services/vad/ten-vad)                          | `uv add pipecat-ten-vad`     | Community  |
...
| [SmolVLM](/api-reference/server/services/vision/smolvlm)     | `uv add pipecat-smolvlm`         | Community  |
